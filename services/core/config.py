    ...
    def _parse_json_secrets(self):
        ...
        if api_keys_json:
            try:
                ...
                self.gemini_model_name = api_keys.get("gemini_model_name", "gemini-2.5-pro")
                self.gemini_embedding_model = api_keys.get("gemini_embedding_model", "models/text-embedding-004")
